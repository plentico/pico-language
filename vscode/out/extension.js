...
function registerCSSDiagnostics(context) {
     ...
     */
    function checkCompoundSelectorParts(selectorPart, allElements, htmlClasses, htmlIds) {
        ...
        if (classesToCheck.length >= 2) {
            ...
            return allElements.some(el => classesToCheck.some(className => el.classes.includes(className)));
        }
        return false;
    }
    /**
